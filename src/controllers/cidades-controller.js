...
export const buscarPontosTaxonomiaComFiltros = async (req, res, next) => {
    try {
        ...
        if (nomeFamilia) {
            whereClause.include.push({
                model: Familia,
                where: { nome: { [Op.eq]: nomeFamilia }, ativo: true },
                attributes: ['id', 'nome'],
                required: true,
            });
        }
        ...
        if (nomeSubFamilia) {
            whereClause.include.push({
                model: Subfamilia,
                where: { nome: { [Op.eq]: nomeSubFamilia }, ativo: true },
                attributes: ['id', 'nome'],
                required: true,
            });
        }
        ...
        if (nomeGenero) {
            whereClause.include.push({
                model: Genero,
                where: { nome: { [Op.eq]: nomeGenero }, ativo: true },
                attributes: ['id', 'nome'],
                required: true,
            });
        }
        ...
        if (nomeEspecie) {
            whereClause.include.push({
                model: Especie,
                where: { nome: { [Op.eq]: nomeEspecie }, ativo: true },
                attributes: ['id', 'nome'],
                required: true,
            });
        }
        ...
        if (nomeSubEspecie) {
            whereClause.include.push({
                model: Subespecie,
                where: { nome: { [Op.eq]: nomeSubEspecie }, ativo: true },
                attributes: ['id', 'nome'],
                required: true,
            });
        }
        ...
        if (nomeVariedade) {
            whereClause.include.push({
                model: Variedade,
                where: { nome: { [Op.eq]: nomeVariedade }, ativo: true },
                attributes: ['id', 'nome'],
                required: true,
            });
        }
